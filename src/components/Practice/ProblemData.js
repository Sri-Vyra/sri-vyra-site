export const problemsByTrack = {
  ...
  'bigdata-sqoop': [
    {
      id: 'sqoop-1',
      title: 'Import Data from MySQL to HDFS',
      description: 'Import the entire "employees" table from MySQL database "company" into HDFS at /user/hadoop/employees.',
      sampleInput: 'Table: employees, Database: company, HDFS Path: /user/hadoop/employees',
      sampleOutput: 'Imported 1000 records into /user/hadoop/employees',
      difficulty: 'Easy',
    },
    {
      id: 'sqoop-2',
      title: 'Import Specific Columns',
      description: 'Import only the columns "id", "name", and "salary" from the "staff" table into HDFS using Sqoop.',
      sampleInput: '--columns id,name,salary',
      sampleOutput: 'Imported selected columns to HDFS directory',
      difficulty: 'Easy',
    },
    {
      id: 'sqoop-3',
      title: 'Import Data with a WHERE Clause',
      description: 'Import only those records from the "orders" table where order_amount > 1000.',
      sampleInput: '--where "order_amount > 1000"',
      sampleOutput: 'Filtered records successfully imported',
      difficulty: 'Easy',
    },
    {
      id: 'sqoop-4',
      title: 'Overwrite Existing HDFS Directory',
      description: 'Import data into /user/hadoop/customers and delete the target directory before import.',
      sampleInput: '--delete-target-dir --target-dir /user/hadoop/customers',
      sampleOutput: 'Old directory deleted and new data imported',
      difficulty: 'Easy',
    },
    {
      id: 'sqoop-5',
      title: 'Import Data Using a Password File',
      description: 'Use a local password file for authentication while importing data from MySQL.',
      sampleInput: '--password-file file:///home/hadoop/passfile',
      sampleOutput: 'Data imported securely using password file',
      difficulty: 'Easy',
    },
    {
      id: 'sqoop-6',
      title: 'Parallel Import using Split-by',
      description: 'Import the "transactions" table using 4 mappers and split the data based on "transaction_id" column.',
      sampleInput: '--split-by transaction_id --m 4',
      sampleOutput: 'Parallel import completed with 4 map tasks',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-7',
      title: 'Incremental Import - Append Mode',
      description: 'Perform an incremental append import on "sales" table where new rows are identified by increasing "sale_id".',
      sampleInput: '--incremental append --check-column sale_id --last-value 100',
      sampleOutput: 'New records with sale_id > 100 imported',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-8',
      title: 'Incremental Import - Lastmodified Mode',
      description: 'Import only rows modified after a certain timestamp from "employee_records" table using lastmodified mode.',
      sampleInput: '--incremental lastmodified --check-column last_update --last-value "2024-12-31 00:00:00"',
      sampleOutput: 'Rows updated after the given date imported successfully',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-9',
      title: 'Import Data Using Query and Conditions',
      description: 'Use a custom SQL query to import only selected records from "products" table with price > 500.',
      sampleInput: '--query "SELECT * FROM products WHERE price > 500 AND \\$CONDITIONS"',
      sampleOutput: 'Conditional data imported using query option',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-10',
      title: 'Import All Tables from Database',
      description: 'Import all tables from the "metadata" database into HDFS warehouse directory.',
      sampleInput: '--connect jdbc:mysql://localhost/metadata --warehouse-dir /user/hadoop/metadata',
      sampleOutput: 'All tables imported into HDFS warehouse',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-11',
      title: 'Import Data Directly into Hive Table',
      description: 'Import MySQL table "user_info" directly into a Hive table named "hive_user_info".',
      sampleInput: '--hive-import --hive-table hive_user_info',
      sampleOutput: 'Data loaded successfully into Hive table',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-12',
      title: 'Create and Run a Sqoop Job',
      description: 'Create a Sqoop job for incremental import and schedule it for execution later.',
      sampleInput: 'sqoop job --create sales_job -- import ...; sqoop job --exec sales_job',
      sampleOutput: 'Sqoop job created and executed successfully',
      difficulty: 'Medium',
    },
    {
      id: 'sqoop-13',
      title: 'Export Data from HDFS to MySQL',
      description: 'Export data from HDFS directory /user/hadoop/exportdata to MySQL table "orders_backup".',
      sampleInput: '--export-dir /user/hadoop/exportdata --table orders_backup',
      sampleOutput: 'Export completed from HDFS to MySQL table',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-14',
      title: 'Import Data with Compression',
      description: 'Import data from MySQL into HDFS using Snappy compression codec.',
      sampleInput: '--compress --compression-codec org.apache.hadoop.io.compress.SnappyCodec',
      sampleOutput: 'Compressed files created in HDFS',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-15',
      title: 'Boundary Query for Custom Splits',
      description: 'Use a custom boundary query to define min and max values for splitting data during parallel import.',
      sampleInput: '--boundary-query "SELECT MIN(id), MAX(id) FROM newdata"',
      sampleOutput: 'Boundary-based parallel import completed',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-16',
      title: 'Import with Direct Mode',
      description: 'Perform high-speed data import using Sqoop’s direct mode for MySQL.',
      sampleInput: '--direct',
      sampleOutput: 'Faster data import completed using direct mode',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-17',
      title: 'Incremental Load into Hive Table',
      description: 'Perform an incremental import from MySQL into an existing Hive table "incremental_sales".',
      sampleInput: '--hive-import --incremental append --check-column sale_id --last-value 500',
      sampleOutput: 'New records appended to Hive table successfully',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-18',
      title: 'Secure Import using HDFS Password File',
      description: 'Store the password file in HDFS and use it for authentication during import.',
      sampleInput: '--password-file hdfs:///user/hadoop/passfile',
      sampleOutput: 'Secure import completed using HDFS password file',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-19',
      title: 'Import Large Table using Multiple Mappers and Split Key',
      description: 'Optimize large table import by using 8 mappers and a numeric key column for parallelization.',
      sampleInput: '--split-by order_id --m 8',
      sampleOutput: 'Data imported efficiently with 8 mappers',
      difficulty: 'Hard',
    },
    {
      id: 'sqoop-20',
      title: 'Custom Query with Join and Conditions',
      description: 'Use a SQL join between "orders" and "customers" tables to import only selected fields into HDFS.',
      sampleInput: '--query "SELECT o.id, c.name, o.amount FROM orders o JOIN customers c ON o.cust_id=c.id WHERE o.amount > 1000 AND \\$CONDITIONS"',
      sampleOutput: 'Joined data imported into HDFS',
      difficulty: 'Hard',
    },
  ],
